...
# This script was taken from https://github.com/facebookresearch/open-eqa/blob/cf472c8a26b1ec7edf6e7cd867af9f5a25998532/data/hm3d/config.py#L1-L4
...
def _create_sensor_spec(
    ...
    spec.position = [0.0, float(sensor_position), 0.0]
